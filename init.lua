...
local function RunInFloatingTerminal(cmd)
	-- open terminal if closed
	if not terminal_state.is_open or not vim.api.nvim_win_is_valid(terminal_state.win) then
		FloatingTerminal()
	end
...
vim.keymap.set("n", "<leader>rp", function()
	RunInFloatingTerminal("cargo run --quiet")
...
vim.keymap.set("n", "<leader>rn", function()
	RunInFloatingTerminal("cargo test -- --nocapture")
